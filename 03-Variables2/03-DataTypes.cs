...
Questions:
1. What is the best data type for a whole number? int
2. What are some data types you could use for decimal numbers? double, bool
...
namespace ProgrammingExercisesIST
{
    class Project_03_DataTypes
    {
        static void Main(string[] args)
        {
            ...
            int freddy = 3;
            double cowcaine = 3.002;
            bool norm = false;
            Console.WriteLine("It is " + norm + " that " + freddy + " equals " + cowcaine + ".");
            Console.ReadLine();
        }
    }
}
